...
#bedtools bamtobed -i trimmed_15.sorted.bam > vir_15.bed
...
echo 'start python count pseudomonas'
python2 TSS_analysis.py count --input clustered_pseudo_0.output --output pseudo_0.output
python2 TSS_analysis.py count --input clustered_pseudo_5.output --output pseudo_5.output
python2 TSS_analysis.py count --input clustered_pseudo_10.output --output pseudo_10.output
python2 TSS_analysis.py count --input clustered_pseudo_15.output --output pseudo_15.output

echo 'start python count LUZ7'
python2 TSS_analysis.py count --input clustered_vir_0.output--output vir_0.output
python2 TSS_analysis.py count --input clustered_vir_5.output--output vir_5.output
python2 TSS_analysis.py count --input clustered_vir_10.output --output vir_10.output
python2 TSS_analysis.py count --input clustered_vir_15.output --output vir_15.output

echo 'STATISTICS R pseudomonas'
R binomialtest.R --no-save pseudo_0.output stats_pseudo_0.output 0.2 < binomialtest.R
R binomialtest.R --no-save pseudo_5.output stats_pseudo_5.output 0.2 < binomialtest.R
R binomialtest.R --no-save pseudo_10.output stats_pseudo_10.output 0.2 < binomialtest.R
R binomialtest.R --no-save pseudo_15.output stats_pseudo_15.output 0.2 < binomialtest.R

echo 'STATISTICS R LUZ7'
R binomialtest.R --no-save vir_0.output stats_vir_0.output 0.2 < binomialtest.R
R binomialtest.R --no-save vir_5.output stats_vir_5.output 0.2 < binomialtest.R
R binomialtest.R --no-save vir_10.output stats_vir_10.output 0.2 < binomialtest.R
R binomialtest.R --no-save vir_15.output stats_vir_15.output 0.2 < binomialtest.R
